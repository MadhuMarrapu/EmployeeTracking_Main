...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<AuthResponse<Object>> handleBadCredentials(BadCredentialsException ex) {
		...
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.UNAUTHORIZED.value(),
				RequestProcessStatus.FAILURE, LocalDateTime.now(), "Login failed", null);
	...
	public ResponseEntity<AuthResponse<Object>> handleUsernameNotFound(UsernameNotFoundException ex) {
		...
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.NOT_FOUND.value(), RequestProcessStatus.FAILURE,
				LocalDateTime.now(), "User lookup failed", null);
	...
	public ResponseEntity<AuthResponse<Object>> handleDuplicateAccount(DuplicateAccountException ex) {
		...
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.CONFLICT.value(), RequestProcessStatus.FAILURE,
				LocalDateTime.now(), "Account creation failed", null);
	...
	public ResponseEntity<AuthResponse<Object>> handleDuplicatePerson(DuplicatePersonException ex) {
		...
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.CONFLICT.value(), RequestProcessStatus.FAILURE,
				LocalDateTime.now(), "person creation failed", null);
		response.setErrorCode(HttpStatus.CONFLICT);
		response.setErrorDescription(ex.getMessage());
		return new ResponseEntity<>(response, HttpStatus.CONFLICT);
	}
	...
	public ResponseEntity<AuthResponse<Object>> handleDuplicateProject(DuplicateProjectException ex) {
		...
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.CONFLICT.value(), RequestProcessStatus.FAILURE,
				LocalDateTime.now(), "Project creation failed", null);
		response.setErrorCode(HttpStatus.CONFLICT);
		response.setErrorDescription(ex.getMessage());
		return new ResponseEntity<>(response, HttpStatus.CONFLICT);
	}
	...
	public ResponseEntity<AuthResponse<Object>> handleManagerNotFoundException(PersonNotFoundException ex,
			HttpServletRequest request) {
		logger.warn("person not found: {}", ex.getMessage());
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.NOT_FOUND.value(), RequestProcessStatus.FAILURE,
				LocalDateTime.now(), "person not found for request path: " + request.getRequestURI(), null);
		response.setErrorCode(HttpStatus.NOT_FOUND);
		response.setErrorDescription(ex.getMessage());
		return new ResponseEntity<>(response, HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<AuthResponse<Object>> handleValidationErrors(MethodArgumentNotValidException ex) {
		...
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.BAD_REQUEST.value(), RequestProcessStatus.FAILURE,
				LocalDateTime.now(), errorMessages, null);
	...
	public ResponseEntity<AuthResponse<Object>> handleGenericException(Exception ex) {
		...
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.INTERNAL_SERVER_ERROR.value(),
				RequestProcessStatus.FAILURE, LocalDateTime.now(), "An unexpected error occurred", null);
	...
	public ResponseEntity<AuthResponse<Void>> handleMissingParams(MissingServletRequestParameterException ex) {
		AuthResponse<Void> response = new AuthResponse<>(HttpStatus.BAD_REQUEST.value(), RequestProcessStatus.FAILURE,
	...
	public ResponseEntity<AuthResponse<Void>> handleTypeMismatch(MethodArgumentTypeMismatchException ex) {
		AuthResponse<Void> response = new AuthResponse<>(HttpStatus.BAD_REQUEST.value(), RequestProcessStatus.FAILURE,
				String.format("Invalid format for parameter '%s': value '%s' is not valid. Expected format: yyyy-MM-dd",
	...
	public ResponseEntity<AuthResponse<Void>> handleMissingDateParam(MissingRequestDateException ex) {
		AuthResponse<Void> response = new AuthResponse<>(HttpStatus.BAD_REQUEST.value(), RequestProcessStatus.FAILURE,
				LocalDateTime.now(), String.format("Missing required parameter: '%s'", ex.getParameterName()), null);
		response.setErrorCode(HttpStatus.BAD_REQUEST);
		response.setErrorDescription(ex.getMessage());
		return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<AuthResponse<Object>> handleReleaseNotFoundException(ReleaseNotFoundException ex,
			HttpServletRequest request) {
		logger.warn("Release not found: {}", ex.getMessage());
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.OK.value(), RequestProcessStatus.SUCCESS,
				LocalDateTime.now(), "Release not found for request path: " + request.getRequestURI(), null);
		response.setErrorCode(HttpStatus.NOT_FOUND);
		response.setErrorDescription(ex.getMessage());
	...
	public ResponseEntity<AuthResponse<Object>> handleTechStackResourceNotFound(TechStackResourceNotFoundException ex,
			HttpServletRequest request) {
		logger.warn("TechStack resource not found: {}", ex.getMessage());
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.OK.value(), RequestProcessStatus.SUCCESS,
				LocalDateTime.now(), "TechStack resource not found for path: " + request.getRequestURI(), null);
		response.setErrorCode(HttpStatus.NOT_FOUND);
		response.setErrorDescription(ex.getMessage());
		return ResponseEntity.ok(response);
	}
	...
	public ResponseEntity<AuthResponse<Object>> handleProjectResourceNotFound(ProjectResourceNotFoundException ex,
			HttpServletRequest request) {
		logger.warn("Project resource not found: {}", ex.getMessage());
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.OK.value(), RequestProcessStatus.SUCCESS,
				LocalDateTime.now(), "Project resource not found for path: " + request.getRequestURI(), null);
		response.setErrorCode(HttpStatus.NOT_FOUND);
		response.setErrorDescription(ex.getMessage());
		return ResponseEntity.ok(response);
	}
	...
	public ResponseEntity<AuthResponse<Object>> handleResourceNotFound(ResourceNotFoundException ex,
			HttpServletRequest request) {
		logger.warn("Resource not found: {}", ex.getMessage());
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.OK.value(), RequestProcessStatus.SUCCESS,
				LocalDateTime.now(), "Resource not found for path: " + request.getRequestURI(), null);
		response.setErrorCode(HttpStatus.NOT_FOUND);
		response.setErrorDescription(ex.getMessage());
		return ResponseEntity.ok(response);
	}
	...
	public ResponseEntity<AuthResponse<Object>> handleSprintNotFound(SprintNotFoundException ex,
			HttpServletRequest request) {
		logger.warn("Sprint not found: {}", ex.getMessage());
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.NOT_FOUND.value(), RequestProcessStatus.FAILURE,
				LocalDateTime.now(), "Sprint not found for request path: " + request.getRequestURI(), null);
		response.setErrorCode(HttpStatus.NOT_FOUND);
		response.setErrorDescription(ex.getMessage());
		return new ResponseEntity<>(response, HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<AuthResponse<Object>> handleReportNotFound(ReportNotFoundException ex) {
		...
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.NOT_FOUND.value(), RequestProcessStatus.FAILURE,
				LocalDateTime.now(), "Progress report lookup failed", null);
		response.setErrorCode(HttpStatus.NOT_FOUND);
		response.setErrorDescription(ex.getMessage());
	...
	public ResponseEntity<AuthResponse<Object>> handleIllegalArgument(IllegalArgumentException ex,
			HttpServletRequest request) {
		logger.warn("Invalid argument at {}: {}", request.getRequestURI(), ex.getMessage());
		AuthResponse<Object> response = new AuthResponse<>(HttpStatus.BAD_REQUEST.value(), RequestProcessStatus.FAILURE,
				LocalDateTime.now(), "Invalid request data", null);
		response.setErrorCode(HttpStatus.BAD_REQUEST);
		response.setErrorDescription(ex.getMessage());
		return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
	}
